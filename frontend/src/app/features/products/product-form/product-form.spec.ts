...
describe('ProductForm', () => {
    ...
    beforeEach(async () => {
        ...
        mockActivatedRoute = {
            snapshot: {
                paramMap: {
                    get: jasmine.createSpy('get').and.returnValue(null), // Default to Create mode
                },
            },
        };
    ...
    describe('Create Mode', () => {
        ...
        it('should handle create error', () => {
            ...
            mockProductService.createProduct.and.returnValue(throwError(() => ({ error: { error: 'Creation failed' } })));
    ...
    describe('Edit Mode', () => {
        beforeEach(() => {
            ...
            mockActivatedRoute.snapshot.paramMap.get.and.returnValue('1'); // Edit mode
