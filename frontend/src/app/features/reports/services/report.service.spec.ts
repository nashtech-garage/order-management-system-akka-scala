...
describe('ReportService', () => {
  ...
  describe('getScheduledReports', () => {
    it('should fetch scheduled reports with default parameters', () => {
      ...
      const req = httpMock.expectOne(`${apiUrl}/scheduled?page=0&pageSize=20`);
    ...
    it('should include date filters when provided', () => {
      ...
      service.getScheduledReports(0, 20, '2024-01-01', '2024-01-31').subscribe();
  ...
  describe('getDailyStats', () => {
    ...
    it('should fetch daily stats with custom days parameter', () => {
      const mockStats: DailyStats[] = [{ date: '2024-01-01', orderCount: 10, revenue: 500 }];
