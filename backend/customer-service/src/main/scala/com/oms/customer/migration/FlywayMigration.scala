package com.oms.customer.migration
...
/**
 * Flyway database migration manager for Customer Service
 */
object FlywayMigration {
  ...
  /**
   * Runs Flyway migrations for the customer database
  ...
  def migrate(jdbcUrl: String, username: String, password: String): MigrateResult = {
    logger.info("Starting Flyway database migration for Customer Service...")
