package com.oms.user.migration
...
/**
 * Flyway database migration manager for User Service
 */
object FlywayMigration {
  ...
  /**
   * Runs Flyway migrations for the user database
  ...
  def migrate(jdbcUrl: String, username: String, password: String): MigrateResult = {
    logger.info("Starting Flyway database migration for User Service...")
