...
trait OrderJsonFormats extends JsonSupport {
  ...
  implicit val confirmOrderRequestFormat: RootJsonFormat[ConfirmOrderRequest] = jsonFormat0(() => ConfirmOrderRequest())
  implicit val shipOrderRequestFormat: RootJsonFormat[ShipOrderRequest] = jsonFormat0(() => ShipOrderRequest())
