package com.oms.order.migration
...
/**
 * Flyway database migration manager for Order Service
 */
object FlywayMigration {
  ...
  /**
   * Runs Flyway migrations for the order database
  ...
  def migrate(jdbcUrl: String, username: String, password: String): MigrateResult = {
    logger.info("Starting Flyway database migration for Order Service...")
